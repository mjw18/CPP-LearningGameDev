...
public:
    /// Updates the balls
    void updateBalls(std::vector <Ball>& balls, float deltaTime, int maxX, int maxY, Grid* grid);
...
private:
	...
	//Check collision between ball and vector of balls startin at specific index
