...
State_GoHome["Execute"] = function(miner)
  ...
  if miner:GoldCarried() > 6 then

	miner:GetFSM():ChangeState(State_EatDinner)
...
State_EatDinner["Enter"] = function(miner)

	print ("[Lua]: I'm feelin' mighty hungry!")

	end

State_EatDinner["Execute"] = function(miner)

	print ("[Lua]: Miner "..miner:Name().." eats some stew")
...
State_EatDinner["Exit"] = function(miner)

	print ("[Lua]: Well that was tasty!")
